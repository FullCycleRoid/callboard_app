...
from .models import AdvUser, SubRubric, SuperRubric, AdditionalImage, Bb, Comment
...
class NoneActivatedFilter(admin.SimpleListFilter):
    ...
    def queryset(self, request, queryset):
        ...
        if val == 'activated':
            ...
            return queryset.filter(is_active=False, is_activated=False, date_joined_date__lt=d)
        elif val == 'week':
